...
class HistoryItem extends StatelessWidget {
  ...
  Color referralCodeColor = Colors.green;
  ...
  Widget build(BuildContext context) {
    ...
    if (rideDetails!.referral_code == false) {
      referralCodeColor = Colors.red;
    }
    return Padding(
                    ...
                    children: [
                      ...
                      Container(
                        padding:
                            EdgeInsets.symmetric(vertical: 10, horizontal: 20),
                        decoration: BoxDecoration(
                          border: Border.all(color: referralCodeColor),
                        ),
                        child: Text(
                          'Referral Code',
                          style: TextStyle(
                              color: referralCodeColor,
                              fontWeight: FontWeight.bold),
                        ),
                      ),
                    ],
